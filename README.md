...
* **Selective Blocking:** Add specific package names (e.g., `com.whatsapp`, `com.instagram`) to a block list.
...
1.  **Download the APK:** Go to the [Releases](https://github.com/muhammad1502/FocusBlocker/releases/tag/release) page and download the latest `.apk`.
